"""CPU tests for ChatGLM's optional pre-RoPE key handoff."""
...
from sglang.srt.models.chatglm import GLMAttention
...
class TestChatGLMPreRopeKey(CustomTestCase):
    def _run(self, required):
        qkv = torch.arange(48, dtype=torch.float32).view(2, 24)
        ...
        harness = SimpleNamespace(
            ...
            rotary_emb=_Rotary(),
            attn=RadixAttention(2, 4, 1.0, num_kv_heads=2, layer_id=0),
            dense=_OutputProjection(),
        )
