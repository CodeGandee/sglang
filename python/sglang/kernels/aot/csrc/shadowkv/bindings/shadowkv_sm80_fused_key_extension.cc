...
TORCH_LIBRARY_FRAGMENT(sgl_kernel, m) {
  ...
  m.def(
      "shadowkv_fused_key_sm80_a100_v3(Tensor u, Tensor sv, Tensor! gathered_u, Tensor cosine, Tensor sine, Tensor component_kinds, "
      "Tensor source_slots, Tensor destination_slots, Tensor miss_ordinals, Tensor selected_chunk_ids, Tensor "
      "selected_lengths, Tensor plan_slots, Tensor! planner_error_codes, Tensor temporal_key_values, int "
      "plan_capacity, Tensor! destination_key_values) -> ()");
  m.impl(
  ...
  m.def(
      "shadowkv_fused_key_sm80_a100_v5(Tensor u, Tensor sv, Tensor! gathered_u, Tensor! reconstructed_misses, "
      "Tensor cosine, Tensor sine, Tensor component_kinds, Tensor source_slots, Tensor destination_slots, Tensor "
      "miss_ordinals, Tensor selected_chunk_ids, Tensor selected_lengths, Tensor plan_slots, Tensor! "
      "planner_error_codes, Tensor temporal_key_values, Tensor! host_miss_counts, int mapped_miss_counts, int "
      "miss_count_ready_event, int plan_capacity, Tensor! destination_key_values) -> ()");
  ...
  m.def(
      "shadowkv_fused_key_mapped_value_sm80_a100_v5(Tensor u, Tensor sv, Tensor! gathered_u, Tensor cosine, "
      "Tensor sine, Tensor component_kinds, Tensor source_slots, Tensor destination_slots, Tensor miss_ordinals, "
      "Tensor selected_chunk_ids, Tensor selected_lengths, Tensor plan_slots, Tensor! planner_error_codes, Tensor "
      "temporal_key_values, Tensor value_miss_chunk_ids, Tensor value_miss_lengths, Tensor descriptor_generation, "
      "Tensor descriptor_validity, int mapped_host_pointer, int mapped_host_bytes, int prompt_chunk_capacity, int "
  ...
  m.impl(
      ...
      torch::kCUDA,
      &shadowkv_fused_key_mapped_value_throttled_a100);
  m.def(
      "shadowkv_fused_key_mapped_value_sm80_a100_v6(Tensor u, Tensor sv, Tensor! gathered_u, Tensor cosine, "
      "Tensor sine, Tensor component_kinds, Tensor source_slots, Tensor destination_slots, Tensor miss_ordinals, "
      "Tensor selected_chunk_ids, Tensor selected_lengths, Tensor plan_slots, Tensor! planner_error_codes, Tensor "
      "temporal_key_values, Tensor value_miss_chunk_ids, Tensor value_miss_lengths, Tensor descriptor_generation, "
      "Tensor descriptor_validity, int mapped_host_pointer, int mapped_host_bytes, int prompt_chunk_capacity, int "
  ...
  m.def(
      "shadowkv_fused_key_mapped_value_sm80_a100_v8(Tensor u, Tensor sv, Tensor! gathered_u, Tensor! "
      "reconstructed_misses, Tensor cosine, Tensor sine, Tensor component_kinds, Tensor source_slots, Tensor "
      "destination_slots, Tensor miss_ordinals, Tensor selected_chunk_ids, Tensor selected_lengths, Tensor plan_slots, "
      "Tensor! planner_error_codes, Tensor temporal_key_values, Tensor value_miss_chunk_ids, Tensor value_miss_lengths, "
      "Tensor descriptor_generation, Tensor descriptor_validity, int mapped_host_pointer, int mapped_host_bytes, int "
